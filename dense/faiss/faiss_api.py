...
class FAISSAPI:
    ...
    def __init__(self,folder_path=None,index_name=None,embedding_function=None):
        self.embedding_function = FAISSAPI.embedding_function if embedding_function is None else embedding_function
    ...
    @staticmethod
    def from_documents(documents,folder_path=None,index_name=None,embedding_function=embedding_function):
    ...
    def add_documents(self,documents):
        ...
        #self.faiss.add_texts([doc.page_content for doc in documents],metadata=[doc.metadata for doc in documents])
        return self
    ...
    @staticmethod
    def load_local(folder_path,index_name,embedding_function=embedding_function):
        faissAPI = FAISSAPI(embedding_function=embedding_function)
        try:
            faissAPI.faiss = FAISS.load_local(
            folder_path=folder_path,
            embeddings=embedding_function, index_name=index_name,allow_dangerous_deserialization=True)
